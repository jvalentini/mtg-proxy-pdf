...
(def test-comma-separated-decklist-string "Academy Rector,Birthing Pod,2x Kitchen Finks,3* Fall of the Hammer,1 Lich's Mirror,4 Mana Flair")
(def test-dash-separated-decklist-string "Academy Rector---Birthing Pod---2   Kitchen Finks---3* Fall of the Hammer---1 Lich's Mirror---4 Mana Flair")
